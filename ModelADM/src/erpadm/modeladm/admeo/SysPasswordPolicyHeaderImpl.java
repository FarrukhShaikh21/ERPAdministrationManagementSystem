...
// ---    Sat Apr 18 22:25:04 PKT 2020
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class SysPasswordPolicyHeaderImpl extends ERPEntityImpl {
    /**
    ...
    public static final int POLICYHEADERCODE = AttributesEnum.PolicyHeaderCode.index();
    public static final int POLICYNAME = AttributesEnum.PolicyName.index();
    public static final int POLICYDATE = AttributesEnum.PolicyDate.index();
    ...
    public static final int POLICYSHORTNAME = AttributesEnum.PolicyShortName.index();
    public static final int SYSPASSWORDPOLICYLINES = AttributesEnum.SysPasswordPolicyLines.index();

    /**
     * This is the default constructor (do not remove).
     */
    public SysPasswordPolicyHeaderImpl() {
    }
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        return EntityDefImpl.findDefObject("erpadm.modeladm.admeo.SysPasswordPolicyHeader");
    }
    ...
    /**
     * Gets the attribute value for PolicyHeaderCode, using the alias name PolicyHeaderCode.
     * @return the value of PolicyHeaderCode
     */
    public Integer getPolicyHeaderCode() {
        return (Integer) getAttributeInternal(POLICYHEADERCODE);
    }

    /**
     * Sets <code>value</code> as the attribute value for PolicyHeaderCode.
     * @param value value to set the PolicyHeaderCode
     */
    public void setPolicyHeaderCode(Integer value) {
        setAttributeInternal(POLICYHEADERCODE, value);
    }

    /**
     * Gets the attribute value for PolicyName, using the alias name PolicyName.
    ...
    /**
     * Sets <code>value</code> as the attribute value for PolicyName.
    ...
    /**
     * Gets the attribute value for PolicyDate, using the alias name PolicyDate.
     * @return the value of PolicyDate
     */
    public Timestamp getPolicyDate() {
        return (Timestamp) getAttributeInternal(POLICYDATE);
    }

    /**
     * Sets <code>value</code> as the attribute value for PolicyDate.
     * @param value value to set the PolicyDate
     */
    public void setPolicyDate(Timestamp value) {
        setAttributeInternal(POLICYDATE, value);
    }
    ...
    /**
     * Gets the attribute value for PolicyShortName, using the alias name PolicyShortName.
     * @return the value of PolicyShortName
     */
    public String getPolicyShortName() {
        return (String) getAttributeInternal(POLICYSHORTNAME);
    }

    /**
     * Sets <code>value</code> as the attribute value for PolicyShortName.
     * @param value value to set the PolicyShortName
     */
    public void setPolicyShortName(String value) {
        setAttributeInternal(POLICYSHORTNAME, value);
    }

    /**
     * @return the associated entity oracle.jbo.RowIterator.
     */
    public RowIterator getSysPasswordPolicyLines() {
        return (RowIterator) getAttributeInternal(SYSPASSWORDPOLICYLINES);
    }


    /**
     * @param policyHeaderSno key constituent

     * @return a Key object based on given key constituents.
     */
    public static Key createPrimaryKey(Integer policyHeaderSno) {
        return new Key(new Object[] { policyHeaderSno });
    }
    ...
    protected void doDML(int operation, TransactionEvent e) {
        if (operation==DML_INSERT) {
           String result = ERPGlobalPLSQLClass.doGetPrimaryKeyValueModel(getDBTransaction(), "POLICY_HEADER_SNO",this.getEntityDef().getSource(), null, null);
           populateAttributeAsChanged(POLICYHEADERSNO, Integer.parseInt(result));
           result = ERPGlobalPLSQLClass.doGetPrimaryKeyValueModel(getDBTransaction(), "POLICY_HEADER_CODE",this.getEntityDef().getSource(), "COMPANY_ID",getCompanyId().toString());
           populateAttributeAsChanged(POLICYHEADERCODE, Integer.parseInt(result));
        }        
